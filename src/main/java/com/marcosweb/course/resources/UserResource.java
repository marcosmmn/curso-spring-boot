...
import com.marcosweb.course.services.UserService;
...
public class UserResource { //camada de apresentação dos dados
	...
	public ResponseEntity<Void> delete(@PathVariable Long id){//pathvariable = ser reconhecido como uma variavel da url
		service.delete(id);
